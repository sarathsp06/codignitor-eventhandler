...
class EventHandler
{
	 ...
	 * TODO:make it an array thats read from memory or so
	 ...
	 *BUGBUG : instead of adding to an array add it to a NOSQL stuff like may be redis or a queue
	 * @access	public
            ...
            foreach ($listeners as $listener) {
                switch ($listener->type) {
                    ...
                    case ListenersTypes::WebHook:
                        $calls[$listener->function] = EventHandler::pingWebHook($listener->function, $event->details);
                        break;
                    default:
